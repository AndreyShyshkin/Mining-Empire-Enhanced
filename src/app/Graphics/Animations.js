...
export class Animations {
	...
	static PlayerIdleRight = new Animation(
		[
			new CreateImageByPath('src/assets/img/Player/IdleRight/Player_idle1.png'),
			new CreateImageByPath('src/assets/img/Player/IdleRight/Player_idle2.png'),
		],
		0.3
	)
	...
	static PlayerJumpRight = new Animation(
		[new CreateImageByPath('src/assets/img/Player/Jump/Player_jump_right.png')],
		0.1
	)
